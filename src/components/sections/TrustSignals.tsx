import { Calculator, ShieldCheck, Users, MapPin } from "lucide-react";
...
const signals = [
  {
    icon: Calculator,
    title: "Real, Sourced Cost Ranges",
    text: "Cost figures reflect well-documented industry pricing, not invented statistics.",
  },
  {
    icon: ShieldCheck,
    title: "Not Financial or Tax Advice",
    text: "Tax credit and financing content explains mechanics honestly and points you to a professional for your specific situation.",
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    text: "20+ years of former-contractor experience behind every guide and every quote.",
  },
];
