...
export function CTA({
  title = "Ready to See a Real Number for Your Project?",
  description = "Get a free, written quote from a vetted installer in CCA's network — no obligation, no pressure.",
