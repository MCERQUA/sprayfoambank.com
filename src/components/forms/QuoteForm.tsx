        ...
        <div className="max-w-2xl mx-auto px-4 md:px-6 text-center">
          <FadeIn>
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              We&apos;ll match you with a vetted installer from CCA&apos;s network and follow up
              within one business day. Need to talk sooner? Call{" "}
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          <label htmlFor="q-street" className="block text-sm font-medium mb-2">Job / Property Address</label>
          <input id="q-street" name="street_address" type="text" required autoComplete="address-line1" placeholder="1234 W Main St"
            className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input id="q-city" name="city" type="text" required autoComplete="address-level2" placeholder="Phoenix"
            className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors" />
        </div>
        <div>
          <label htmlFor="q-state" className="block text-sm font-medium mb-2">State</label>
          <select id="q-state" name="state" required autoComplete="address-level1" defaultValue=""
            className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors">
      ...
      <div>
        ...
        <input id="q-zip" name="zip" type="text" required inputMode="numeric" pattern="[0-9]{5}(-[0-9]{4})?" maxLength={10} autoComplete="postal-code" placeholder="Property ZIP code"
          className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors" />
      </div>

      <div>
        <label htmlFor="q-project" className="block text-sm font-medium mb-2">What Are You Looking For?</label>
        <select id="q-project" name="project_type" required defaultValue=""
          className="w-full px-4 py-3 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors">
      ...
      <div>
        <label htmlFor="q-details" className="block text-sm font-medium mb-2">Details (optional)</label>
        <textarea id="q-details" name="details" rows={4} placeholder="Tell us about your project."
      ...
      >
        {isSubmitting ? "Submitting..." : (<>Get My Free Quote <Send className="w-4 h-4" /></>)}
      </button>
