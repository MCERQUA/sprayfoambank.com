    ...
    <main>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-6 pt-36 pb-16 md:pt-48 md:pb-20 text-center">
          <p className="text-sm font-semibold text-accent uppercase tracking-wider mb-3">The Money Side</p>
      ...
      <section className="py-20 md:py-28 bg-background">
        <div className={content.hasCalculator ? "max-w-6xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-5 gap-12" : "max-w-3xl mx-auto px-4 md:px-6"}>
          <div className={content.hasCalculator ? "lg:col-span-2" : ""}>
            <FadeIn>
      ...
      <FAQ
        ...
        subtitle="Real questions people ask before starting a spray foam project."
        faqs={content.faqs}
      />
